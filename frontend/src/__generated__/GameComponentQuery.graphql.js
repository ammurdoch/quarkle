/**
 * @flow
 * @relayHash fc46b05bca8664713232be0a805c59d4
 */
...
export type GameComponentQueryVariables = {|
  gameId: string,
  playerId: string,
|};
export type GameComponentQueryResponse = {|
  +myGame: ?{|
    +game: ?{|
      +turn: ?{|
        +id: string,
  ...
  |}
|};
export type GameComponentQuery = {|
  variables: GameComponentQueryVariables,
  response: GameComponentQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    ...
    "name": "GameComponentQuery",
    "id": null,
    "text": "query GameComponentQuery(\n  $gameId: String!\n  $playerId: String!\n) {\n  myGame(gameId: $gameId) {\n    game {\n      turn {\n        id\n        name\n      }\n      ...BoardComponentFragment\n      ...ScoreBoardComponentFragment\n      id\n    }\n    you(playerId: $playerId) {\n      id\n      ...HandComponentFragment_2bzg04\n    }\n    id\n  }\n}\n\nfragment BoardComponentFragment on GameNode {\n  tilesPlayed {\n    edges {\n      node {\n        x\n        y\n        tile {\n          id\n          shape\n          color\n        }\n        id\n      }\n    }\n  }\n}\n\nfragment HandComponentFragment_2bzg04 on PlayerNode {\n  id\n  name\n  score\n  hand(playerId: $playerId) {\n    edges {\n      cursor\n      node {\n        id\n        shape\n        color\n      }\n    }\n  }\n}\n\nfragment ScoreBoardComponentFragment on GameNode {\n  players {\n    edges {\n      cursor\n      node {\n        id\n        name\n        score\n      }\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'b2418dab55808d12dba053decf7e052b';
